...
public class RefundOrderInfo implements Serializable {
	...
	public String toString() {
		return "RefundOrderInfo [id=" + id + ", quantity=" + quantity
				+ ", name=" + name + ", productSacle=" + productSacle
				+ ", remark=" + remark + ", returnSum=" + returnSum
				+ ", productPrice=" + productPrice + ", nowPrice=" + nowPrice
