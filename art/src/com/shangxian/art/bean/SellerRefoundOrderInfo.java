 ...
 *
 */
public class SellerRefoundOrderInfo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -85516394504227609L;
	...
	@Expose
	private List<SellerRefoundOrderProductInfo> returnOrderItemDtos = new ArrayList<SellerRefoundOrderProductInfo>();
	...
	public List<SellerRefoundOrderProductInfo> getReturnOrderItemDtos() {
		return returnOrderItemDtos;
	}

	public void setReturnOrderItemDtos(
			List<SellerRefoundOrderProductInfo> returnOrderItemDtos) {
	...
	public String toString() {
		return "SellerRefoundOrderInfo [status=" + status + ", returnOrderNum="
