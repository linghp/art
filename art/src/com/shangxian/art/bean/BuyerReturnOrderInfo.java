...
public class BuyerReturnOrderInfo implements Serializable {
	...
	@Expose
	private List<BuyerReturnOrderProductInfo> returnOrderItemDtos = new ArrayList<BuyerReturnOrderProductInfo>();
	...
	public boolean isNull(){
		return TextUtils.isEmpty(status) || returnOrderItemDtos == null || returnOrderItemDtos.size() == 0;
	}
	...
	public void setReturnOrderItemDtos(
			List<BuyerReturnOrderProductInfo> returnOrderItemDtos) {
