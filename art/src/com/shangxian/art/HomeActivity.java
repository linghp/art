...
import com.shangxian.art.bean.HomeadsBeanAll.HomeadsBean;
...
public class HomeActivity extends BaseActivity implements
	...
	private List<HomeadsBean> listHomeadsBean_ads = new ArrayList<HomeadsBean>();
...
//	private List<HomeadsBeanAll> listHomeadsBean1 = new ArrayList<>();
							...
							if (result_code.equals("200")) {
								...
								for (int i = 0; i < length; i++) {
									JSONObject jo = resultObjectArray
											.getJSONObject(i);
									HomeadsBeanAll homeadsBeanAll = gson.fromJson(
											jo.toString(), HomeadsBeanAll.class);
									if(homeadsBeanAll.getAdViewType().equals("BANNER")){
									imgList.add(Constant.BASEURL
											+ homeadsBeanAll.getIndexDto().getImageUrl());
									listHomeadsBean_ads.add(homeadsBeanAll.getIndexDto());
									}else if(homeadsBeanAll.getAdViewType().equals("ONE")){
									HomeadsBean homeadsBean=homeadsBeanAll.getIndexDto();
										...
										View view2 = mInflater.inflate(
												...
												null);
										List<HomeadsBean> listHomeadsBean_three=homeadsBeanAll.getIndexDtos();
										for (int j = 0; j < listHomeadsBean_three.size(); j++) {
											if (j == 0) {
												...
												layoutParams.width = (CommonUtil
														...
														.dip2px(HomeActivity.this,
																10)) * 61 / 100;
												layoutParams.height = layoutParams.width * 47 / 100;
												iv.setLayoutParams(layoutParams);
												Imageloader_homePager
														.displayImage(
																Constant.BASEURL
