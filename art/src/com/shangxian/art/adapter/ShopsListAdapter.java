...
//    	this.mTo = to;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
       ...
       TextView items_bottom = (TextView) convertView.findViewById(R.id.items_bottom);
       TextView items_bottom1 = (TextView) convertView.findViewById(R.id.items_bottom1);
		  //获取该行的数据
...
//       String imageUrl = (String)obj.get("itemsIcon");
       ...
       //设置加载中的View
       mAbImageLoader.display(itemsIcon, Constant.BASEURL+shopsListModel.getLogo());
       //图片的下载
