...
public class ClassifyCommodityActivity extends BaseActivity{
	...
	private void initScreenPopupWindow() {
		...
		//引入窗口配置文件
		view = inflater.inflate(R.layout.screen_popupwindow, null);
		//创建popupwindow对象
		...
		//得到popupwindow里面的控件
		shopslist = (TextView) view.findViewById(R.id.screen_shopslist);
		classifylist = (TextView) view.findViewById(R.id.screen_classifylist);
		...
		classifylist.setOnClickListener(new OnClickListener() {
