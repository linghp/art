...
//import com.peoit.android.polwork.config.Constants;
//import com.peoit.android.polwork.ioc.annotation.Inject;
//import com.peoit.android.polwork.ioc.annotation.InjectAssert;
//import com.peoit.android.polwork.ioc.annotation.InjectExtra;
//import com.peoit.android.polwork.ioc.annotation.InjectResource;
//import com.peoit.android.polwork.ioc.annotation.InjectView;
//import com.peoit.android.polwork.util.FileUtil;
import com.shangxian.art.ioc.annotation.Inject;
import com.shangxian.art.ioc.annotation.InjectAssert;
import com.shangxian.art.ioc.annotation.InjectExtra;
import com.shangxian.art.ioc.annotation.InjectResource;
import com.shangxian.art.ioc.annotation.InjectView;
import com.shangxian.art.utils.FileUtil;

/*import wobble.android.peoit.com.wobble.config.Constants;
import wobble.android.peoit.com.wobble.ioc.annotation.Inject;
import wobble.android.peoit.com.wobble.ioc.annotation.InjectAssert;
import wobble.android.peoit.com.wobble.ioc.annotation.InjectExtra;
import wobble.android.peoit.com.wobble.ioc.annotation.InjectResource;
import wobble.android.peoit.com.wobble.ioc.annotation.InjectView;
import wobble.android.peoit.com.wobble.util.FileUtil;*/
...
public class InjectUtil {
    ...
    private static  boolean isCommonClazz(Class<?> clazz){
        ...
        if(isok)return true;
        if(Constant.ioc_instal_pkg!=null){
            for (int i = 0; i <Constant.ioc_instal_pkg.length; i++) {
                if(pkg.startsWith(Constant.ioc_instal_pkg[i]))return true;
            }
        }
        return false;
    }
