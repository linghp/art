...
public class MyOrder_dfk_Fragment extends Fragment implements HttpCilentListener {
...
//							MyLogger.i(myOrderItems_temp.size()+"");
//							for (MyOrderItem myOrderItem : myOrderItems_temp) {
//								
//							}
						}
